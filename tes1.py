...
# ===== BPM STATE =====
prev_state = "center"     # can be "left", "center", or "right"
beat_count = 0
beat_times = []
last_beat_time = None
MIN_BEAT_INTERVAL = 0.25  # anti-double-count
...
with mp_hands.Hands(
    ...
    while True:
        ...
        if results.multi_hand_landmarks and len(results.multi_hand_landmarks) >= 2:
            ...
            # average 2 hands → convert to approx center = 0
            avg_x = (sum(wrist_xs) / len(wrist_xs)) - 0.5

            # determine zone: left / right / center
